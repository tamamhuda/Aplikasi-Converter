...
$result = mysqli_query($conn, "SELECT * FROM users WHERE username='$username' ORDER BY id DESC LIMIT 1");
	...
	<div class="form-upload">
		...
		<div class="file-upload">
		  <div class="file-upload-wrap">
		  	<input class="file-upload-input" type="file" name="pdf" onchange="readURL(this);" />
		  	<img style="width: 70px; margin-top: 30px;" src="../img/up-pdf.png">
		  ...
		  <div class="file-upload-content">
		    <img style="width: 70px; " src="../img/PDF.png">
